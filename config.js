(function () {
  ...
  var config = {
    baseAppUrl: "https://embed-z5kz.onrender.com",
    port: 8061,
    relativeStaticUrl: "/s",
    use_http2: true,
    DEBUG: false,
    ...
    HTTP2_RETRY_CODES_LIST: ["ECONNRESET", "ESOCKETTIMEDOUT"],
    ...
    PROMO_RELS: ["player", "image", "thumbnail"],
    ...
    FEATURES: [
      // feature policy: https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Feature-Policy#Directives
    ...
    REL: {
      ...
      twitter: ["player", "photo"],
      og: ["video"],
      oembed: ["link", "rich", "video", "photo"],
      "html-meta": ["video", "embedURL"],
    },
    ...
    // To detect: "html-meta".
    KNOWN_SOURCES: ["oembed", "og", "twitter", "iframely"],
  ...
  if (!config.USER_AGENT) {
    ...
    config.USER_AGENT =
      ...
      version +
      " (+" +
      (baseAppUrlForAgent || "https://github.com/itteco/iframely") +
      ")";
  }
